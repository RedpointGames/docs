...
:::danger Studios and professional developers: Important information about support availability
Your purchase includes Standard Support, which is only available Wednesday - Friday, Melbourne time. Standard Support is provided on a "best effort" basis, which means it will take longer for us to get to your support case when we have a high number of cases.

We recommend that studios purchase a [Premium Support](https://licensing.redpoint.games/support/plans) plan _at least 6 months_ before your game's scheduled release date. Premium Support provides a next business day SLA, Monday - Friday support, and ensures that we're available to support your game's release.
:::

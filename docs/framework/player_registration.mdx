...
:::danger
You **must** use a session name of `GameSession` when creating your sessions in order for `RedpointGameSession` to work. If you are using a session name other than `GameSession`, you won't see players automatically registered or unregistered.
:::

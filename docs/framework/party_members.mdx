...
On your party member actor, you should add components that are needed to render players such as static and skeletal mesh components, as well as widget components that you can use to show the player's name. The ["Minute of Mayhem" example project](../example_project.mdx) demonstrates how to do this.

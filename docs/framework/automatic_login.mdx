...
:::info
For a more comprehensive example of how to implement a custom startup screen, download the [Minute of Mayhem example project](../example_project.mdx#minute-of-mayhem).
:::

...
![A screenshot of where to open](./core_getting_started/plugins_open.png)
...
![A screenshot of the product page](./core_getting_started/plugins_enable_eos.png)

1. Click on **Networking** in the side bar.
1. Tick the enable box for the EOS Online Framework plugin.

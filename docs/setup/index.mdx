...
This guide can be used to set up your own new or existing Unreal Engine project, or to set up the [example project](../example_project.mdx) with your own EOS product ID.
...
If you're using the example projects, you'll see the game launch into an "already logged in" state. You should also see your account username in the top-left:

![A screenshot of the example project being already signed in](./core_getting_started/unreal_example.png)

If you're not using the example projects, you should see a successful sign in the Output Log if you filter for "Authentication":

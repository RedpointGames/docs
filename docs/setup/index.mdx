...
After installation, the plugin is not enabled in projects by default. To enable the plugin in the editor, open the Plugins window:

![A screenshot of the menu that is used to open the Plugins window.](./core_getting_started/plugins_open.png)

1. Click on **Edit** in the top menu bar.
1. Click **Plugins**.

From the Plugins window, search for "EOS Online Framework" and enable it for your project:

![A screenshot of the Plugins page, filtered to networking plugins.](./core_getting_started/plugins_enable_eos.png)

1. Click on **Networking** in the side bar.
1. Tick the checkbox to enable the "EOS Online Framework" plugin.

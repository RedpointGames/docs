/* Used with explicit permission from blueprintue.com. Modified to support Online Subsystem Blueprints. */
(function () {
  "use strict";
  ...
  (Interpreter.prototype.parseText = function (e) {
    ...
    (Interpreter.prototype.changeNodeIfNecessary = function () {
      ...
      /**
       * BEGIN: Online Subsystem Blueprints specific changes.
       */
      this.isOSBSubsystemNode()
        ? ((e = new NOSBSubsystem()), this.replaceNode(e))
        : /**
         * END: Online Subsystem Blueprints specific changes.
         */
        this.isConvNode()
    ...
    /**
     * Online Subsystem Blueprints specific changes.
     */
    (Interpreter.prototype.isOSBSubsystemNode = function () {
      var e = this.currentNode.props.CustomClass;
      return (
        void 0 !== e &&
        -1 !== e.indexOf("/Script/OnlineSubsystemBlueprints.Online") &&
        -1 !== e.indexOf("Subsystem")
      );
    }),
   ...
   * BEGIN: Online Subsystem Blueprints specific changes.
   */
  function NOSBSubsystem() {
    UNode.call(this);
  }
  (((NOSBSubsystem.prototype = new UNode()).constructor =
    NOSBSubsystem).prototype.generateHtml = function () {
    return (
      this.disableTextOnPins(),
      {
        tag: "div",
        class: ["node", "nosbsubsystem"],
        attrs: [
          { name: "style", value: this.generateCssNodeStyle().join(";") },
          { name: "data-id", value: this.guid },
        ],
    ...
    (NOSBSubsystem.prototype.generateHtmlBody = function () {
      var t = this.props.CustomClass;
      t = t.substring(
        t.indexOf("/Script/OnlineSubsystemBlueprints.") +
          "/Script/OnlineSubsystemBlueprints.".length
      );
      t = t.substring(0, t.indexOf("Subsystem\"'"));
      var c = [];
      var l = 0;
      var ll = 0;
      for (var i = 1; i < t.length; i++) {
        if (t[i] == t[i].toUpperCase() && t[i] != "I" && t[i - 1] != "U") {
          if (c.length > 0) {
            c.push({ tag: "br" });
          }
          c.push({
            tag: "span",
            text: t.substring(l, i),
            childs: t.substring(l, i),
          });
          ll++;
          t = t.substring(0, i) + "\n" + t.substring(i);
          l = i;
      ...
      return {
        tag: "div",
        class: ["body"],
        attrs: [{ name: "style", value: "height: " + (28 * ll + 25) + "px;" }],
        childs: [
          {
            tag: "div",
            class: ["center-text"],
            childs: [{ tag: "span", childs: c }],
          },
          { tag: "div", class: ["round-bg"] },
          {
            tag: "div",
            class: ["left-col"],
            childs: this.generateHtmlPinsInput(),
    ...
    (NOSBSubsystem.prototype.disableTextOnPins = function () {
      for (var t = 0; t < this.pins.length; t++) this.pins[t].disableText();
    });
  /**
   * END: Online Subsystem Blueprints specific changes.
   */
